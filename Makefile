...
DIST_COMMON = README $(am__configure_deps) $(srcdir)/Makefile.am \
	...
	$(top_srcdir)/configure COPYING TODO compile config.guess \
...
ACLOCAL = ${SHELL} /Users/ikarus/Work/ikarus-scheme/missing --run aclocal-1.9
AMDEP_FALSE = #
AMDEP_TRUE = 
...
AUTOMAKE = ${SHELL} /Users/ikarus/Work/ikarus-scheme/missing --run automake-1.9
AWK = awk
CC = gcc
CCAS = gcc
CCASFLAGS = -I/opt/local/include
CCDEPMODE = depmode=gcc3
CFLAGS = -I/opt/local/include -DNDEBUG -O3
CPP = gcc -E
CPPFLAGS = 
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
