...
;;; Extracted from Chez Scheme Version 7.0 (Sep 02, 2005)
...
; does not introduce any ids, uses ellipsis?
...
;;; NO GOOD, introduced begin, $module, $import
(put-cte-hook 'module
  (lambda (x)
...
; NO GOOD, introduces begin, $module, $import, alias
(let ()
...
(current-expand (lambda (x . rest) (apply #%sc-expand (sc-expand x) rest)))
